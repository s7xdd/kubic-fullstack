...
class WishExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    ...
    public function headings(): array
    {
        return [
            ...
            ['Sl No.', 'Product SKU', 'Product Name', 'Number of Wish'],
        ];
    }
    ...
    public function map($products): array
    {
        ...
        return [
            ...
            $products->sku,
            $products->name,
            (string)$products->wishlists->count() ?? 0
        ];
    }
}
