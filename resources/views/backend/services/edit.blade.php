    ...
    <div class="card">
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('service.update', $service->id) }}" method="POST"
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">Short Title</label>
                    <div class="col-md-9">
                        <input type="text" name="short_title" value="{{ $service->getTranslation('short_title', $lang) }}" class="form-control" id="short_title" placeholder="{{ trans('messages.name') }}">
                    </div>
                </div>
