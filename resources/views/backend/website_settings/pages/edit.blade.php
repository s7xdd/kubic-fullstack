        ...
        <form class="p-4" action="{{ route('custom-pages.update', $page->id) }}" method="POST"
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">Title 1 <span
                            class="text-danger">*</span> </label>
                    <div class="col-sm-10">
                        <input type="text"  class="form-control" placeholder="Title 1" name="title1"
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">Title 2 <span
                            class="text-danger">*</span> </label>
                    <div class="col-sm-10">
                        <input type="text"  class="form-control" placeholder="Title 2" name="title2"
            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="5" class="resize-off form-control" placeholder="{{ trans('messages.meta_description') }}" name="meta_description">{!! $page->getTranslation('meta_description', $lang) !!}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea   rows="3" class="resize-off form-control" placeholder="{{ trans('messages.meta_keywords')}}" name="keywords">{!! $page->getTranslation('keywords', $lang) !!}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea  rows="5" class="resize-off form-control" placeholder="{{ trans('messages.og_description') }}" name="og_description">{!! $page->getTranslation('og_description', $lang) !!}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea  rows="5" class="resize-off form-control" placeholder="{{ trans('messages.twitter_description') }}"
